...
class TransformerSentenceEncoderLayer(nn.Module):
    ...
    def build_adapter(self, input_size):
        return Adapter(input_size)
    ...
    def forward(
        ...
        if self.adapter is not None:
            x = self.adapter(x, residual_input=residual_adapter, residual_laynorm=residual)
