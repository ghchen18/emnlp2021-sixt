...
def add_preprocess_args(parser):
    ...
    group.add_argument('--xlmr-task', default='encft', type=str,
                       choices=['vanilla','encnoft'],
                       help='perform task related to xlmr')
    group.add_argument('--mplm-type', default='xlmr', type=str,
                       choices=['xlmr','xlm'], help='type of multilingual pretrained model')
    # fmt: on
    return parser
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    # fmt: off
    group.add_argument('--num-workers', default=8, type=int, metavar='N',
    ...
    group.add_argument('--xlmr-task', default='encnoft', type=str,
                       choices=['vanilla','embnoft','embnoft_ms','encft_embft_decft','encft_embrand_decrand','encfix_embrand_decrand','encfix_embfix_decfix','encfix_embft_decrand','encfix_embfix_decrand','encfix_embfix_decft','encfix_embfix_decfix','encfix_embft_decfix','encfix_embft_decft','xlmr_2stage','xlmr_2stage_posdrop','encrand_embrand_decrand','encft_embft_decrand','encft_embfix_decrand'], 
                       help='perform task related to xlmr')
    group.add_argument('--xlmr-modeldir', metavar='DIR', default='xlmr_base',
                       help='path to load XLM-R model')
    group.add_argument('--ft-last-f-dir', metavar='DIR', default='last_base',
                       help='path to load trained model of encfix-embfix-decrand model.')
    group.add_argument('--layerwise-lr', default='1.0', type=eval_str_list,
                       metavar='LR_1,LR_2,...,LR_N', help='layer-wise learning rate for 2 stage finetune')
    group.add_argument('--resdrop-layer', default='10', type=int, metavar='N',
                        help='which encoder layer to drop the residual connection after self-attention.')
    group.add_argument('--mplm-type', default='xlmr', type=str,
                       choices=['xlmr','xlm','xlmrL'], help='type of multilingual pretrained model')     
    group.add_argument('--use-random-resdrop', action="store_true", help='type of language adapter used.')
    group.add_argument('--add-both-adapters', action="store_true", help='type of language adapter used.')                    
...
def add_generation_args(parser):
    ...
    group.add_argument('--decoding-path', metavar='DIR', help='path to save generated translations.')
