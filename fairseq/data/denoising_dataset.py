...
class DenoisingDataset(FairseqDataset):
    ...
    def __getitem__(self, index):
        with data_utils.numpy_seed(self.seed, self.epoch, index):
            ...
            tgt_str = self.tgt_dict.string(tokens)
            source = self.vocab.encode_line(line=tgt_str,line_tokenizer=tokenize_line,add_if_not_exist=False,append_eos=True,reverse_order=False).type_as(tokens)
